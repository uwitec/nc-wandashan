	...
	public  BalFreezeVO[] getBySueprVO(Map<String,SuperVO> map) throws Exception{
		...
		for (Map.Entry entry : map.entrySet()) {
			...
			String[] strs = str.split("&");
  			 v_seq1 = pro_qryMny("yf",PuPubVO.getString_TrimZeroLenAsNull(strs[0]),PuPubVO.getString_TrimZeroLenAsNull(strs[1]),PuPubVO.getString_TrimZeroLenAsNull(strs[2]));
  			 v_seq2 = pro_qryMny("fk",PuPubVO.getString_TrimZeroLenAsNull(strs[0]),PuPubVO.getString_TrimZeroLenAsNull(strs[1]),PuPubVO.getString_TrimZeroLenAsNull(strs[2]));
