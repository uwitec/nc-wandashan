...
import nc.bs.hg.pu.check.FundPrepareBO;
...
import nc.ui.uapde.nodepublish.PublishControler.FunProperty;
...
//			String sdeptid, UFDate uDate, UFDouble nmny, String pk_planother_b,
...
//	}
	...
	public void commitPlan(List planinfor, PlanApplyInforVO infor,
		...
		if (HgPubConst.PLAN_MNY_BILLTYPE.equals(splantype)) {
			// 为专项资金计划资金定额预留
			FundPrepareBO bo = new FundPrepareBO(getPubBO().getBaseDao());
			bo.LockFundForPlan(planinfor, lseldata, infor.getM_sLogCorp());
		}
		// zhw end
		// PubDMO dmo = null;
		try {
