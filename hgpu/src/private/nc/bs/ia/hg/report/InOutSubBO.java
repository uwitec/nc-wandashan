...
//		zhf add  其他入库单  数量 金额 2011-08-24
		fac.getQryBO(IaInOutSumBOFactory.type_in_other, getDao()).getDatas(datas,sdate1, sdate2, cons);
...
//		
//		自用数量金额   zhf 2011-08-24  鹤岗需求  不再查看自用数量金额
//		fac.getQryBO(IaInOutSumBOFactory.type_out_self, getDao()).getDatas(datas,sdate1, sdate2, cons);
		
		
//		zhf add  其他出库单  数量 金额 2011-08-24
		fac.getQryBO(IaInOutSumBOFactory.type_out_other, getDao()).getDatas(datas,sdate1, sdate2, cons);
