...
public class NewMaterialsVO extends SuperVO {
	...
	private UFDouble storeunitnum;//多少标准存储单位
	private String pk_prodline;//产品线属性
	private String sealflag;//封存标志
	private UFBoolean ismngstockbygrswt;//按毛重管理库存
	private String graphid;//图号
	private String forinvname;//外文名称
	private UFBoolean setpartsflag;//是否成套件
	private String pk_measdoc2;//采购默认单位
	private String invpinpai;//品牌
	private UFDouble weitunitnum;//多少标准重量单位
	private String pk_measdoc1;//销售默认单位
	private UFDouble length;//长度
	private UFBoolean isstorebyconvert;//换算率结存
	private UFBoolean assistunit;//是否辅计量管理
	private UFDouble shipunitnum;//多少标准运输单位
	private UFBoolean autobalancemeas;//自动平衡主辅计量
	private String invbarcode;//条形码
	private String invshortname;//存货简称
	private String pk_measdoc5;//生产默认单位
	private UFDouble unitvolume;//单位重量
	private UFDouble unitweight;//单位体积
	private UFDouble height;//高度
	private String pk_measdoc3;//库存默认单位
	private UFDouble width;//宽度
	private String pk_measdoc6;//零售计量单位
	private UFBoolean isretail;//是否零售
	...
	public void setStoreunitnum(UFDouble storeunitnum) {
	...
	public void setIsmngstockbygrswt(UFBoolean ismngstockbygrswt) {
	...
	public void setWeitunitnum(UFDouble weitunitnum) {
	...
	public void setAssistunit(UFBoolean assistunit) {
		this.assistunit = assistunit;
	}
	public UFDouble getShipunitnum() {
		return shipunitnum;
	}
	public void setShipunitnum(UFDouble shipunitnum) {
		this.shipunitnum = shipunitnum;
	}
	public UFBoolean getAutobalancemeas() {
		return autobalancemeas;
	}
	public void setAutobalancemeas(UFBoolean autobalancemeas) {
	...
	public void setPk_measdoc5(String pk_measdoc5) {
		this.pk_measdoc5 = pk_measdoc5;
	}
	public UFDouble getUnitvolume() {
		return unitvolume;
	}
	public void setUnitvolume(UFDouble unitvolume) {
		this.unitvolume = unitvolume;
	}
	public UFDouble getUnitweight() {
		return unitweight;
	}
	public void setUnitweight(UFDouble unitweight) {
	...
	public void setPk_measdoc6(String pk_measdoc6) {
		this.pk_measdoc6 = pk_measdoc6;
	}
	public UFBoolean getIsretail() {
		return isretail;
	}
	public void setIsretail(UFBoolean isretail) {
