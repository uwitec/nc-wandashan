...
public class BalancePlanUI extends ToftPanel implements IBillRelaSortListener2{
	...
	private ButtonObject m_btnUnAudit = new ButtonObject("未审批","未审批",2,"未审批");
...
//		initAppInfor();
	...
	public void setButtonSatus(boolean isbalance){
		m_btnBalance.setEnabled(!isbalance);
		m_btnUnBalance.setEnabled(isbalance);
		m_btnADUT.setEnabled(!isbalance);
		m_btnUnAudit.setEnabled(!isbalance);
		updateButtons();
	}
