...
public class CHGHG04TO5X extends VOConversionUI
{
	...
	{
		return 	"nc.ui.hg.pu.conversion.PlanVOTO5X";
	}
...
//						"B_bretractflag->B_bretractflag",//-------------------------------
						...
						"B_vbdef12->B_vbdef12",
						"B_vbdef11->B_vbdef11",
						"B_vbdef11->H_cplanprojectid",//计划项目
						"B_vbdef10->B_vbdef10",
						"B_vbdef9->B_vbdef9",
						"B_vbdef8->B_vbdef8",
						"B_vbdef7->B_vbdef7",
	...
	public String[] getFormulas()
	{
        ...
        "B_nquoteunitrate->1.0",
				"B_csourcetypecode->\"HG04\"",
				"B_bsettleendflag->\"N\"",
				"B_btakesettleendflag->\"N\"",
				"B_bsendendflag->\"N\"",
				"B_boutendflag->\"N\"",
        "B_nnum->B_nnum-zeroifnull(B_nouttotalnum)",
        "B_nquoteunitnum->B_nnum-zeroifnull(B_nouttotalnum)",
        //单据类型
        "H_cbilltype->\"5X\"",
        "B_cbilltype->\"5X\"",
        "H_fallocflag->1",
