 ...
 */
     public class ZgjzHVO extends SuperVO {    
  /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
			public String pk_outwhouse;//发货仓库
	         public String pk_intwhouse;//收货仓库
	         public UFDate dbegindate;//开始日期
	         public UFDate denddate;//截止日期
	         public String pk_wds_zgjz_h;//主表主键
	         public Integer ilacktype;//欠发类型
           //预留字段
	...
	public void setPk_busitype(String newPk_busitype) {
        ...
        /**
	   * 属性pk_intwhouse的Getter方法.
	   *
	   * 创建日期:2011-12-15
	   * @return String
	   */
	 public String getPk_intwhouse() {
		 return pk_intwhouse;
	  }   
	  
     /**
	   * 属性pk_intwhouse的Setter方法.
	   *
	   * 创建日期:2011-12-15
	   * @param newPk_intwhouse String
	   */
	public void setPk_intwhouse(String newPk_intwhouse) {
		
		pk_intwhouse = newPk_intwhouse;
	 } 	  
	...
	public void setVdef10(String newVdef10) {
        ...
        /**
	   * 属性ilacktype的Getter方法.
	   *
	   * 创建日期:2011-12-15
	   * @return Integer
	   */
	 public Integer getIlacktype() {
		 return ilacktype;
	  }   
	  
     /**
	   * 属性ilacktype的Setter方法.
	   *
	   * 创建日期:2011-12-15
	   * @param newIlacktype Integer
	   */
	public void setIlacktype(Integer newIlacktype) {
		
		ilacktype = newIlacktype;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_wds_zgjz_h == null) {
			errFields.add(new String("pk_wds_zgjz_h"));
			  }	
	 ...
	 *
	 * 创建日期:2011-12-15
	 * @param newPk_wds_zgjz_h 主键值
	 */
	 public ZgjzHVO(String newPk_wds_zgjz_h) {
	  ...
	  * @param newPk_wds_zgjz_h  String    
	  */
	 public void setPrimaryKey(String newPk_wds_zgjz_h) {
