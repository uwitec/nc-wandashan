...
public class EventHandler {
	...
	public class ICardEventHandler extends TreeCardEventHandler {
		...
		protected void onBoSave() throws Exception {
			...
			checkBeforeSave((LoadpriceVO) aggVo.getParentVO());
			super.onBoSave();
		...
		private void checkBeforeSave(LoadpriceVO chnlMemTypeVO) throws Exception {
		...
		public void onBoAdd(ButtonObject bo) throws Exception {
			super.onBoAdd(bo);
			getBillCardPanelWrapper().getBillCardPanel().setHeadItem("fiscoded", UFBoolean.TRUE);
		}
		...
		protected void onBoRefresh() throws Exception {
			...
			getBillTreeCardUI().modifyRootNodeShowName("装卸费价格");
		...
		protected void onBoReturn() throws Exception {
			getBillUI().getMultiAppManager().showNext(
					"nc.ui.wds.load.price.ClientListUI");
		}
	}
}
