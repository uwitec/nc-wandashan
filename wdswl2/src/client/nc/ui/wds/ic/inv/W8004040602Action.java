...
public class W8004040602Action extends BdBusinessAction {
	...
	Iw8004040204 iw = null;
	
	private Iw8004040204 getIwImpl(){
		if(iw == null){
			iw = (Iw8004040204) NCLocator.getInstance().lookup(
	...
	public AggregatedValueObject save(AggregatedValueObject billVO,
		...
		AggregatedValueObject retVo = getIwImpl().saveBD8004040602(billVO, userObj);
	...
	public nc.vo.pub.AggregatedValueObject delete(
		...
		AggregatedValueObject retVo = getIwImpl().deleteBD8004040204(billVO, userObj);
		return null;
	}
