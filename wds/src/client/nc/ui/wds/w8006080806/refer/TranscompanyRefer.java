...
public class TranscompanyRefer extends AbstractRefModel {
	...
	private String m_sTableName= "(select tc_pk,tc_comcode,tc_comname from tb_transcompany where  dr=0  )tmp ";
	/**
	 * RouteRefModel 构造子注解。
	 */
	public TranscompanyRefer() {
		super();
	}
