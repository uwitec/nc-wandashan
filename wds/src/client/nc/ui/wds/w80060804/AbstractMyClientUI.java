...
import nc.ui.wds.w80060804.tcButtun.TcOpenBtn;
import nc.ui.wds.w80060804.tcButtun.TcStopBtn;
 ...
 */
  public abstract class AbstractMyClientUI extends nc.ui.trade.multichild.MultiChildBillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.wds.w80060804.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		TcOpenBtn customizeButton1 = new TcOpenBtn();
		addPrivateButton(customizeButton1.getButtonVO());
		TcStopBtn customizeButton2 = new TcStopBtn();
