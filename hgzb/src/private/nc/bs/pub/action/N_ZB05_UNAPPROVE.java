...
import nc.bs.zb.entry.ZbEntryBo;
 ...
 *
 */
public class N_ZB05_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_ZB05_UNAPPROVE() {
		super();
	}
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			HYBillVO vo1 = (HYBillVO)billvo;
			ZbResultHeadVO headvo =(ZbResultHeadVO)vo1.getParentVO();
			//校验是否可以弃审
			ZbEntryBo bo = new ZbEntryBo();
			bo.isExitDownBillApprove(headvo);
