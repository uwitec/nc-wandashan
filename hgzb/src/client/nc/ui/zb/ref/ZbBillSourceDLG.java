 ...
 * 
 */
public class ZbBillSourceDLG extends BillSourceDLG {
	...
	// 来源参照对话框
	private ZbBillSourceDLG m_sourcedlg = null;
	// 当前（目的）单据UI
	 ...
	 * @param parent
	 */
	public ZbBillSourceDLG(String pkField, String pkCorp, String operator,
	...
	private BillTempletVO filterNoShowBody(BillTempletVO vo) throws Exception {
		...
		BillTempletVO retvo = (BillTempletVO) VOTool.aggregateVOClone(vo);
