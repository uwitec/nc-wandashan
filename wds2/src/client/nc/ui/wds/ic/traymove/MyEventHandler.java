...
public class MyEventHandler extends AbstractMyEventHandler {
	...
	protected void onBoSave() throws Exception {
		...
		if (null == ((StockInvOnHandVO) billVO.getParentVO()).getPplpt_pk()) {
		...
		// 未修改前托盘
		String whs_pk = ((StockInvOnHandVO) billVO.getParentVO()).getWhs_pk();
		...
		whss = (ArrayList) query.retrieveByClause(StockInvOnHandVO.class,
				whsysql);
		//
		String pplptysql = " cdt_pk='"
				+ ((StockInvOnHandVO) whss.get(0)).getPplpt_pk()
				+ "' and dr=0 ";
		...
		// 修改后
		String pplptx_pk = ((StockInvOnHandVO) billVO.getParentVO())
				.getPplpt_pk();
		...
		//
		if (!((StockInvOnHandVO) whss.get(0)).getPplpt_pk().equals(pplptx_pk)) {
		...
		tbMovetrayVO.setMakeman_pk(ClientEnvironment.getInstance().getUser()
				.getPrimaryKey());
		tbMovetrayVO.setOuttray_pk(((StockInvOnHandVO) whss.get(0))
				.getPplpt_pk());
		tbMovetrayVO.setIntray_pk(pplptx_pk);

		tbMovetrayVO
				.setPk_invbasdoc(((StockInvOnHandVO) billVO.getParentVO())
						.getPk_invbasdoc());
		tbMovetrayVO.setMty_stockpieces(((StockInvOnHandVO) billVO
				.getParentVO()).getWhs_stockpieces());
		tbMovetrayVO.setMty_stocktonnage(((StockInvOnHandVO) billVO
				.getParentVO()).getWhs_stocktonnage());
		tbMovetrayVO.setDbilltime(getBillUI()._getServerTime().toString());
		tbMovetrayVO.setDr(0);
		tbMovetrayVO
				.setPk_customize(((StockInvOnHandVO) billVO.getParentVO())
						.getPk_cargdoc());
