...
public class SimpBillRefListPanelPlanTo4D extends SimpBillRefListPanel{
	RefPlanQueryDlg queryDlg = null;

  public SimpBillRefListPanelPlanTo4D(
  ...
  public DefaultSrcRefCtl getSourcectl(){
     if(sourcectl==null){
          sourcectl = new SourceRefDlgCtrlPlanTo4D(getCsourcetype(),getCtargettype(),getPk_corp(),this,queryDlg);
        }
     return sourcectl;
  }
