...
//		Object o = LongTimeTask.callRemoteService("ic", bo, "queryPactsByVendor", ParameterTypes, ParameterValues, 2);
	...
	public static Object cancelPactMatch(GeneralBillVO gbillvo) throws Exception{
		Class[] ParameterTypes = new Class[]{GeneralBillVO.class};
		Object[] ParameterValues = new Object[]{gbillvo};
		Object o = LongTimeTask.callRemoteService("ic", bo, "cancelPactMatch", ParameterTypes, ParameterValues, 2);
		return o;
	...
	public static List<GeneralBillItemVO> splitGItemsOnPactMatch(GeneralBillItemVO gitem,PactVO[] pvos){
		...
		for(PactVO pvo:pvos){
			...
			tmpItem.setNprice(pvo.getNoriginalcurprice());//原币无税单价
...
//		int ss = tmpItem.getStatus();
	 ...
	 * @throws Exception
	 */
	public static Object getcvendor(ArrayList al) throws Exception{
	 ...
	 * @throws Exception
	 */
	public static Object callPurchasePactPrice(String pk_invmandoc ,String vbatch,String corp) throws Exception{
		Class[] ParameterTypes = new Class[]{String.class,String.class,String.class};
		Object[] ParameterValues = new Object[]{pk_invmandoc,vbatch,corp};
		Object o;
		o = LongTimeTask.callRemoteService("ic", bo, "callPurchasePactPrice", ParameterTypes, ParameterValues, 2);
	 ...
	 * @throws Exception
	 */
	public static Object getAllowanceSet(String pk_invbasid) throws Exception{
		Class[] ParameterTypes = new Class[]{String.class};
		Object[] ParameterValues = new Object[]{pk_invbasid};
		Object o;
		o = LongTimeTask.callRemoteService("ic", bo, "getAllowanceSet", ParameterTypes, ParameterValues, 2);
		return o;
	}
	 ...
	 * @throws Exception
	 */
	public static Object getInfoByBatchCode(ArrayList al) throws Exception{
		Class[] ParameterTypes = new Class[]{ArrayList.class};
		Object[] ParameterValues = new Object[]{al};
		Object o;
