...
public abstract class BillEventHandler extends EventHandler {
	...
	public void onBillRef() throws Exception {
		ButtonObject btn = new ButtonObject(nc.ui.ml.NCLangRes.getInstance()
...
//						);
    ...
    */
	...
	protected void onBoCommit() throws Exception {
		...
		String strTime = getBillUI().getEnvironment().getServerTime()
				.toString();
...
//							);
	...
	public void onBoApproveInfo() throws Exception{
		...
		FlowStateDlg dlg = new FlowStateDlg(getBillUI().getParent(), billType,IPFConfigInfo.STATEBUSINESSTYPE, billId);
		dlg.setVisible(true);
	...
	protected void setAddNewOperate(boolean isAdding,
		...
		if (isAdding) {
			...
			getBufferData()
					.setCurrentRow(getBufferData().getVOBufferSize() - 1);
		}
	}
