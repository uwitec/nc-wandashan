 ...
 * @author mlr
 */
public class LinkBillFlowDlg extends UIDialog implements ActionListener {
	...
	public LinkBillFlowDlg(Container parent, String billType, String billID,
	...
	public LinkBillFlowDlg(Container parent, LightBillVO voBillInfo) {
		super(parent);
	...
	public void actionPerformed(java.awt.event.ActionEvent e) {
		if (e.getSource() == exitMenu) {
			...
			if (node != null && node.getModel() != null) {
				LinkBillFlowDlg f = new LinkBillFlowDlg(this, node.getModel().getType(), node.getModel().getID(),bizType, userID, pk_corp);				
				f.showModal();
			}
		}
	}
