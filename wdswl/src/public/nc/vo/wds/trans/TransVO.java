...
public class TransVO extends SuperVO {
	...
	public String ss_custom2;//调出公司
	public String ss_remark;
	public String ss_custom6;//调入仓库;
	public String ss_custom3;
	public String ss_pk;// 主键
	...
	public Integer ss_isout;//存货属性   0-大包粉  , 1-箱粉（袋）,2-箱粉(听)
	public  UFBoolean isok ;//
	
	private UFDouble price;//运价()
	
	private UFDouble mail;//公里数()
