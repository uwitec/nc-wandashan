 ...
 */
     public class LoadpriceHVO extends SuperVO {
             ...
             public static final String  FLOADTYPE="floadtype";   
	...
	public void setVdef9(String newVdef9) {
     ...
     /**
	   * 属性floadtype的Setter方法.
	   *
	   * 创建日期:2011-5-3
	   * @param newFloadtype Integer
	   */
	public void setFloadtype(Integer newFloadtype) {
		
		floadtype = newFloadtype;
	 } 	  
	 ...
	 */
	 public LoadpriceHVO(String newPk_loadprice) {
