...
public class InvbasdocVO extends SuperVO {
	...
	public UFBoolean getUisso() {
		return uisso;
	}

	public void setUisso(UFBoolean uisso) {
		this.uisso = uisso;
	}

	public UFBoolean getUisdm() {
		return uisdm;
	}

	public void setUisdm(UFBoolean uisdm) {
		this.uisdm = uisdm;
	}
