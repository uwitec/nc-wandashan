 ...
 */
     public class TanscorpHVO extends SuperVO {
    	 
    	 
    	  //关联的仓库
         public String pk_stordoc;
         public String vlawpsn; //法人
         public String pk_wds_tanscorp_h;           
        
         public String vtranscorpaddr;//运输公司地址
         public String ctranscorpcode;//编码
         public String vtranscorpname;//名称
         public String vfax;//传真
         public String vofficespace;   //办公点  
         public String vemail; //邮箱         
         public UFDate dstartdate;//合同开始日期 
         public UFDate denddate;//合同结束日期
    	...
    	//预留字段
    		...
    		//业务员id
             ...
             public static final String  VLAWPSN="vlawpsn";   
             ...
             public static final String  VTRANSCORPADDR="vtranscorpaddr";   
             public static final String  CTRANSCORPCODE="ctranscorpcode";   
             ...
             public static final String  VOFFICESPACE="vofficespace";   
             ...
             public static final String  VTRANSCORPNAME="vtranscorpname";   
	...
	public void setVdef4(String newVdef4) {
     ...
     /**
	   ...
	   *
	   * 创建日期:2011-5-19
	   * @param newVlawpsn String
	   */
	public void setVlawpsn(String newVlawpsn) {
	...
	public void setDenddate(UFDate newDenddate) {
        ...
        /**
	   * 属性vtranscorpaddr的Getter方法.
	   *
	   * 创建日期:2011-5-19
	   * @return String
	   */
	 public String getVtranscorpaddr() {
		 return vtranscorpaddr;
	  }   
	  
     /**
	   * 属性vtranscorpaddr的Setter方法.
	   *
	   * 创建日期:2011-5-19
	   * @param newVtranscorpaddr String
	   */
	public void setVtranscorpaddr(String newVtranscorpaddr) {
		
		vtranscorpaddr = newVtranscorpaddr;
	 } 	  
       
        /**
	   * 属性ctranscorpcode的Getter方法.
	   *
	   * 创建日期:2011-5-19
	   * @return String
	   */
	 public String getCtranscorpcode() {
		 return ctranscorpcode;
	  }   
	  
     /**
	   * 属性ctranscorpcode的Setter方法.
	   *
	   * 创建日期:2011-5-19
	   * @param newCtranscorpcode String
	   */
	public void setCtranscorpcode(String newCtranscorpcode) {
		
		ctranscorpcode = newCtranscorpcode;
	 } 	  
	...
	public void setPk_defdoc3(String newPk_defdoc3) {
        ...
        /**
	   * 属性vofficespace的Getter方法.
	   *
	   * 创建日期:2011-5-19
	   * @return String
	   */
	 public String getVofficespace() {
		 return vofficespace;
	  }   
	  
     /**
	   * 属性vofficespace的Setter方法.
	   *
	   * 创建日期:2011-5-19
	   * @param newVofficespace String
	   */
	public void setVofficespace(String newVofficespace) {
		
		vofficespace = newVofficespace;
	 } 	  
	...
	public void setVdef10(String newVdef10) {
        ...
        /**
	   * 属性vtranscorpname的Getter方法.
	   *
	   * 创建日期:2011-5-19
	   * @return String
	   */
	 public String getVtranscorpname() {
		 return vtranscorpname;
	  }   
	  
     /**
	   * 属性vtranscorpname的Setter方法.
	   *
	   * 创建日期:2011-5-19
	   * @param newVtranscorpname String
	   */
	public void setVtranscorpname(String newVtranscorpname) {
		
		vtranscorpname = newVtranscorpname;
	 } 	  
	 ...
	 */
	 public void validate() throws ValidationException {
	 	...
	 	ArrayList errFields = new ArrayList(); // errFields record those null
	   		...
	   		if (pk_wds_tanscorp_h == null) {
			errFields.add(new String("pk_wds_tanscorp_h"));
			  }	
	 ...
	 *
	 * 创建日期:2011-5-19
	 * @param newPk_wds_tanscorp_h 主键值
	 */
	 public TanscorpHVO(String newPk_wds_tanscorp_h) {
	  ...
	  * @param newPk_wds_tanscorp_h  String    
	  */
	 public void setPrimaryKey(String newPk_wds_tanscorp_h) {
