...
public class AvailNumBO extends AvailNumBoTool {
	...
	public Map<String, String[]> getTypetoAccountFields() throws Exception {
		if (typetofields == null || typetofields.size() == 0) {
			typetofields.put(WdsWlPubConst.WDS3, new String[] { "h.pk_corp",
					"h.pk_outwhouse", null, "b.pk_invmandoc", "b.pk_invbasdoc",
					null, "b.vdef1", null, });
			typetofields.put(WdsWlPubConst.WDSG, new String[] { "h.pk_corp",
					"h.pk_outwhouse", null, "b.pk_invmandoc", "b.pk_invbasdoc",
					null, "b.vdef1", null, });
			typetofields.put(WdsWlPubConst.WDSS, new String[] { "h.pk_corp",
					"h.pk_outwhouse", null, "b.pk_invmandoc", "b.pk_invbasdoc",
					null, "b.vdef1", null, });
			typetofields.put(WdsWlPubConst.WDS5, new String[] { "h.pk_corp",
					"h.pk_outwhouse", null, "b.pk_invmandoc", "b.pk_invbasdoc",
					null, "b.vdef1", null, });
		}
		return typetofields;
	...
	public Map<String, String> getTypetoQuerySql() throws Exception {
		if (typetosql == null || typetosql.size() == 0) {
			typetosql
					.put(
							WdsWlPubConst.WDS3,
							" select   h.pk_corp pk_corp,h.pk_outwhouse pk_customize1,b.pk_invmandoc pk_invmandoc,b.pk_invbasdoc pk_invbasdoc,b.vdef1 ss_pk,"
