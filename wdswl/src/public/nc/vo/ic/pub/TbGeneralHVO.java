...
//             public static final String  PWB_PK="pwb_pk";
	...
	public void setPwb_fbillflag(Integer newPwb_fbillflag) {
     ...
     /**
	   ...
	   */
	public void setPk_corp(String newGeh_corp) {
	...
	public void setPk_customize9(String newPk_customize9) {
     ...
     /**
	   ...
	   */
	public void setGeh_freplenishflag(UFBoolean newGeh_freplenishflag) {
	 ...
	 */
	 ...
	 public void validateBeforSave()  throws ValidationException{
		 //供应链中其他出库允许出库仓库和入库仓库相同，所以这个校验去掉
		 if(getGeh_cwarehouseid() == null || "".equalsIgnoreCase(getGeh_cwarehouseid()) ){
			 throw new   ValidationException("入库仓库不能为空");
		 }
		 if(getGeh_cwarehouseid().equalsIgnoreCase(getGeh_cotherwhid()== null?"":getGeh_cotherwhid())){
			// throw new   ValidationException("出库仓库和入库仓库不能相同");
		 }
	 }
