 ...
 * @author zpm
 */
public class N_WDS7_CANELSIGN extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas=new java.util.Hashtable();
	private Hashtable m_keyHas=null;

	public N_WDS7_CANELSIGN() {
		super();
	}
	/*
	* 备注：平台编写规则类
...
//			是否回传erp
			...
			UFBoolean isreturn = PuPubVO.getUFBoolean_NullAs(setbo.isReturnErp(headvo.getGeh_cdispatcherid()), UFBoolean.FALSE);

			if(isreturn.booleanValue()){//如果回传了erp  删除erp下游单据
