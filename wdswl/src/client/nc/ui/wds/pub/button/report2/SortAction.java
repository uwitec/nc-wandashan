...
import nc.ui.wds.pub.report2.ZmSortDLG;
/**
 * ≈≈–Ú
 * @author guanyj1
 */
public class SortAction extends AbstractActionHasDataAvailable {
	...
	public void execute() throws Exception {
		...
		if (ZmSortDLG.showModal() == UIDialog.ID_OK)
		{
			if (ZmSortDLG.getSortFields() != null)
			{
				...
				getReportBaseUI().showHintMessage(nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report","UPPuifactory_report-000034")/*@res "≈≈–Ú≥…π¶"*/);
			}
		}
	}
	private ZmSortDLG getZmSortDLG()
	{
			...
			ZmSortDLG = new ZmSortDLG(getReportBaseUI(), nc.ui.ml.NCLangRes.getInstance().getStrByID("uifactory_report","UPPuifactory_report-000006")/*@res "≈≈–Ú…Ë÷√"*/, getReportBaseUI()
					.getVisibleFields(), null);
		return ZmSortDLG;
	}
