package nc.ui.wds.report.fjcbh;
...
public class ReportUI extends ReportBaseUI{
	...
	public ReportBaseVO[] getReportVO(String wheresql) throws BusinessException {
		...
		try{
			...
			Object o = LongTimeTask.calllongTimeService(WdsWlPubConst.WDS_WL_MODULENAME, this, 
					"正在查询...", 1, "nc.bs.wds.report.fjcbh.ReportBO", null, 
	...
	public void onQuery() {
		...
		if(sql==null||sql.length()==0){
		      sql="  tb_warehousestock.pk_corp = '"+_getCorpID()+"'";
		}else{
		    sql = sql + "  and tb_warehousestock.pk_corp = '"+_getCorpID()+"'";
		}
		ReportBaseVO[] vos;
		try {
			vos = getReportVO(sql);
