 ...
 *其他出库 参照 特殊运单
 */
public class RefWDSSBillSourceDlg  extends MBillSourceDLG {
	/**
	 * 
	 */
	...
	public RefWDSSBillSourceDlg(String pkField, String pkCorp, String operator,
	...
	public String getHeadCondition() {
		...
		" and wds_soorder.icoltype= 0";//出入库类型为  出库
	}
