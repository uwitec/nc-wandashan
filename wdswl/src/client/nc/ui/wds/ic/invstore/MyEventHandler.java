...
public class MyEventHandler extends ManageEventHandler {
	...
	public void onBoAdd(ButtonObject bo) throws Exception {
		...
		SuperVO[] vos=HYPubBO_Client.queryByCondition(CargdocVO.class, " wds_cargdoc1.pk_cargdoc='"+login.getSpaceid()+"' and isnull(wds_cargdoc1.dr,0)=0 and pk_corp = '"+ _getCorp().getPrimaryKey()+"'");
