 ...
 * 
 * @作者：zhf
 * @说明：完达山物流项目  是否存在左侧控制控件
 * @时间：2011-7-1下午12:50:08
 * @return
 */
protected abstract boolean isExitLeftContrlCom();

/**
 * 
 * @作者：zhf
 * @说明：完达山物流项目 是否存在右侧控制控件
 * @时间：2011-7-1下午12:50:28
 * @return
 */
protected abstract boolean isExitRightContrlCom();
///**
