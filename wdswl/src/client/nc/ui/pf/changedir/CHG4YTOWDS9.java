...
//			"B_geb_dbizdate->B_dbizdate"//业务日期 [重新赋值，入库日期]
	...
	public String[] getFormulas() {
		return new String[] {
				...
				"B_geb_snum->B_noutnum-getColValue(ic_general_b,nkdnum,cgeneralbid,B_cgeneralbid)",//应发数量 
				"B_geb_bsnum->B_noutassistnum-getColValue(ic_general_b,nkdnumb,cgeneralbid,B_cgeneralbid)",//应发辅数量
////				zhf add 运单类型
