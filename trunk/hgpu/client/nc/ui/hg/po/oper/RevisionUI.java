...
import nc.ui.po.oper.OrderUIQueDlg;
import nc.ui.po.oper.PoToftPanel;
import nc.ui.po.oper.PoToftPanelButton;
import nc.ui.po.oper.RevisionUIButton;
...
protected nc.ui.po.pub.PoListPanel getInitPoListPanel(POPubSetUI2 setUi) {
	...
	PoListPanel	listBill =
		new PoListPanel(this, PoPublicUIClass.getLoginPk_corp(), HgPubConst.PO_REVISE_1,setUi);
	//只允许单选监听
