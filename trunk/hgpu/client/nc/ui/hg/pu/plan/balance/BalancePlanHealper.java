...
public class BalancePlanHealper {
	 ...
	 * @throws Exception
	 */
	public static PlanMonDealVO[] queryPlans(String whereSql,ClientLink cl,boolean isbalance,String str) throws Exception{
		Class[] ParameterTypes = new Class[]{String.class,ClientLink.class,boolean.class,String.class};
		Object[] ParameterValues = new Object[]{whereSql,cl,isbalance?true:false,str};
	 ...
	 * @throws Exception
	 */
	public static void aduitPlans(ToftPanel tp,List datas) throws Exception{
