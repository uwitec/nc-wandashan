...
//	public static final String[] CHECK_FUND_NAME2 = new String[]{"nlockfund","nactfund"};//资金字段
	...
	private static java.util.Map<String, String> m_puchTypeInfor1 = null;
	public static java.util.Map<String,String> getDefDoc_PuchType1() throws BusinessException{
		if(m_puchTypeInfor1 == null||m_puchTypeInfor1.size()==0){			
			...
			m_puchTypeInfor1 = new HashMap<String, String>();
			int size= al.size();
			for(int i=0;i<size;i++){
				Object ob = al.get(i);
				if(ob != null){
					Object[] str = (Object[])ob;
					m_puchTypeInfor1.put(PuPubVO.getString_TrimZeroLenAsNull(str[0]),PuPubVO.getString_TrimZeroLenAsNull(str[1]));
				}
			}
		}
		return m_puchTypeInfor1;
	}
//	public static 
}
