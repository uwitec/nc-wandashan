...
public class HgPubConst {
	...
	public static final String PO_REVISE_1 = "2B1";//订单处理
	
	public static String FREEZE_VENTOR = "FREE";//供应商冻结
...
//	public static int PLAN_TYPE_MNY = 2;//专项资金计划
	...
	public static final String DEFDOC_NAME="领料单位";
...
//	public static String PLAN_Balance_BILLTYPE1 = "BALANCE1";//计划平衡单据类型  模板使用 该模板没有 选中框
	...
	public static final String HGGYC_CORP="1002";
	
	public static String GYC_CORPID = "1002";
	
	public static String ALLO_ORDER_TABLE_STORE="stock";//调拨订单库存存量信息页签编码

	public static String Expenses_Flow="0001A51000000000OA8B";//运费流程主键
	public static String usableamountbyfree="NYY";//可用量是否按自由项计算
	public static String usableamount="0000000101000000";//存货可用量计算方案字符串
