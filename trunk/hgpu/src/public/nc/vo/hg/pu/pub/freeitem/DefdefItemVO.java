...
public FieldObject[] getFields() {
	...
	FieldObject[] fields = {getPk_defdocField(), getPk_defdefField(), getPk_defdoc1Field(), getDoccodeField(), getDocnameField(), getTsField(), getDrField()};
