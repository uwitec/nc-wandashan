 ...
 *
 */
public class N_HG04_APPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_HG04_APPROVE() {
		super();
	}
...
//				PraybillVO voPrayBill  = (PraybillVO)changeData(planvo, HgPubConst.PLAN_MNY_BILLTYPE, ScmConst.PO_Pray);
//				PraybillVO[] voPrayBills = new PraybillVO[]{voPrayBill};
				PraybillVO[] voPrayBills = (PraybillVO[])changeDataAry(new HYBillVO[]{planvo}, HgPubConst.PLAN_MNY_BILLTYPE, ScmConst.PO_Pray);
