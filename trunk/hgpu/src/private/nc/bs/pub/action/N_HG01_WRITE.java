...
public class N_HG01_WRITE extends AbstractCompiler2 {
...
try{
	...
	try {
			...
			retObj = runClass("nc.bs.hg.pu.plan.year.YearPlanBillSave", "saveBill","nc.vo.pub.AggregatedValueObject:01", vo, m_keyHas,	m_methodReturnHas);
