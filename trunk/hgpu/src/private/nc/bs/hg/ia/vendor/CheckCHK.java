 ...
 */
	...
	private void onCheckSave(HYBillVO vo) throws Exception {
		...
		UFDouble temp =PuPubVO.getUFDouble_NullAsZero(bvo.getNfreamount()).sub(PuPubVO.getUFDouble_NullAsZero(getByString(custbasid, szxmid, pk_corp, vdef1)));
		...
		if(ccustbasid ==null && szxmid==null )
		  ...
		  UFDouble v_seq1 =UFDouble.ZERO_DBL ;//--应付款总额
	   	  ...
	   	  UFDouble v_seq3 = UFDouble.ZERO_DBL;// --冻结总额
  			 ...
  			 v_seq1 = pro_qryMny("yf",PuPubVO.getString_TrimZeroLenAsNull(ccustbasid),PuPubVO.getString_TrimZeroLenAsNull(szxmid),PuPubVO.getString_TrimZeroLenAsNull(pk_corp));
  			 v_seq2 = pro_qryMny("fk",PuPubVO.getString_TrimZeroLenAsNull(ccustbasid),PuPubVO.getString_TrimZeroLenAsNull(szxmid),PuPubVO.getString_TrimZeroLenAsNull(pk_corp));
	...
	private void checkeunique(String custbasid,String custmanid,String szxmid,String pk_corp,String vdef1,String pk_balfreeze  ) throws BusinessException{
		...
		String len = PuPubVO.getString_TrimZeroLenAsNull(getBaseDao().executeQuery(str.toString(), HgBsPubTool.COLUMNPROCESSOR));
	...
	private UFDouble pro_qryMny(String djdl,String ksbm_cl,String szxmid,String pk_corp) throws DAOException{
...
//			sql +=" and b.deptid= '"+vdef1+"'";
//		else 
//			sql +=" and b.deptid is null ";
	...
	private UFDouble pro_qryFreezeMny(String ksbm_cl, String szxmid,
		...
		String sql = " select sum(nfreamount) from hg_balfreeze where isnull(dr,0)=0 and ccustbasid  ='"
		...
		if(PuPubVO.getString_TrimZeroLenAsNull(deptid)!=null)
		     sql +=" and vdef1 <>'"+deptid+"'";
		sql +=" group by ccustbasid";
