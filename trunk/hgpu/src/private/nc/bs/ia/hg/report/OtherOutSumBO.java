...
public class OtherOutSumBO extends AbstractInOutSumQryBO {

	public OtherOutSumBO(BaseDAO dao) {
		super(dao);
	...
	public String buildSql(String date1, String date2, String whereCondition) {
		...
		str.append(",sum(b.noutnum) nnum,sum(b.nplannedmny) nmny");
		...
		str.append(" where nvl(b.dr,0)=0 and nvl(h.dr,0) = 0 and nvl(iab.dr,0) = 0 and h.cregister is not null and h.cbilltypecode = '4I'");
...
//		str.append(", b.cinvbasid,b.cinventoryid ");
	...
	protected void appData2(IaInvInOutReportVO data, InOutSumPubVO num) {
		...
		if(data == null || num == null)
			return;
		data.setNdef3(num.getNnum());
		data.setNdef4(num.getNmny());
	}
}
