...
public class N_F3_SAVE extends AbstractCompiler2
{
    ...
    {
        return "\t//####本脚本必须含有返回值,返回DLG和PNL的组件不允许有返回值####\n\tObject retObj=null;\n//####重要说明：生成的业务组件方法尽量不要进行修改####\n//####重要说明：生成的业务组件方法尽量不要进行修改####\n//方法说明:null\nretObj=runClassCom@\"nc.bs.ep.dj.DJZBBO\",\"save\",\"nc.vo.ep.dj.DJZBVO:F3\"@;\n//##################################################\nreturn retObj;\n";
    }
        ...
        throws nc.vo.pub.BusinessException
    {
        try
        {
    		...
    		//  zhw end
            Object obj = null;
            obj = runClass("nc.bs.ep.dj.DJZBBO", "save", "nc.vo.ep.dj.DJZBVO:F3", pfparametervo, m_keyHas, m_methodReturnHas);
            if(obj != null)
                m_methodReturnHas.put("save", obj);
            return obj;
        }
