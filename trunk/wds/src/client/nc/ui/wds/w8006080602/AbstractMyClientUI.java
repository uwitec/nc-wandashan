...
import nc.ui.wds.w8006080602.cfButtun.CfStopBtn;
import nc.ui.wds.w8006080602.cfButtun.CfOpenBtn;
 ...
 */
  public abstract class AbstractMyClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.wds.w8006080602.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		CfStopBtn customizeButton1 = new CfStopBtn();
		addPrivateButton(customizeButton1.getButtonVO());
		CfOpenBtn customizeButton2 = new CfOpenBtn();
