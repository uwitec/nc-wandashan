...
import nc.ui.wds.w80060604.czlbButtun.cfddBtn;
import nc.ui.wds.w80060604.czlbButtun.czlbBtn;
import nc.ui.wds.w80060604.czlbButtun.fczlBtn;
import nc.ui.wds.w80060604.czlbButtun.hbddBtn;
import nc.ui.wds.w80060604.czlbButtun.zcddBtn;
 ...
 */
  public abstract class AbstractMyClientUI extends nc.ui.trade.manage.BillManageUI implements  ILinkQuery{
	...
	protected BusinessDelegator createBusinessDelegator() {
		return new nc.ui.wds.w80060604.MyDelegator();
	}
	...
	protected void initPrivateButton() {
		czlbBtn customizeButton1 = new czlbBtn();
		addPrivateButton(customizeButton1.getButtonVO());
		cfddBtn customizeButton3 = new cfddBtn();
		addPrivateButton(customizeButton3.getButtonVO());
		hbddBtn customizeButton4 = new hbddBtn();
		addPrivateButton(customizeButton4.getButtonVO());
		fczlBtn customizeButton5 = new fczlBtn();
		addPrivateButton(customizeButton5.getButtonVO());
		zcddBtn customizeButton6 = new zcddBtn();
