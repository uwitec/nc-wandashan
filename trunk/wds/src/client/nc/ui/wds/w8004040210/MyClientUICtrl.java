...
public class MyClientUICtrl extends AbstractManageController {
	...
	public int[] getCardButtonAry() {
		...
		return new int[] { nc.ui.wds.w8004040210.ssButtun.ISsButtun.SsAdd,
				IBillButton.Query, IBillButton.Edit, IBillButton.Save,
				IBillButton.Cancel, IBillButton.Return, IBillButton.Refresh,
				nc.ui.wds.w8004040210.ssButtun.ISsButtun.CtAdd,
	...
	public int[] getListButtonAry() {
		return new int[] { nc.ui.wds.w8004040210.ssButtun.ISsButtun.SsAdd,
				IBillButton.Query, IBillButton.Edit, IBillButton.Save,
				IBillButton.Cancel, IBillButton.Card, IBillButton.Refresh,
				nc.ui.wds.w8004040210.ssButtun.ISsButtun.CtAdd,
				nc.ui.wds.w80020206.buttun0206.ISsButtun.Qzqr,
				nc.ui.wds.w80020206.buttun0206.ISsButtun.Qxqz
				 };
