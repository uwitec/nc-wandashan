...
public class W80060208Action extends BdBusinessAction {
	private AbstractBillUI billUI=null;

	public W80060208Action(AbstractBillUI billUI){
		super();
		this.billUI=billUI;
	}
	...
	public AggregatedValueObject save(AggregatedValueObject billVO,
		...
		AggregatedValueObject retVo = iw.saveBD80060208(billVO, userObj);
