...
public class TrayDisposeDetailDlg extends nc.ui.pub.beans.UIDialog implements
	...
	private TbGeneralBVO chlid = null;

	private TbGeneralBVO[] chlids = null;
	...
	public TbGeneralBVO getChlid() {
		return chlid;
	}

	public void setChlid(TbGeneralBVO chlid) {
		this.chlid = chlid;
	}

	public TrayDisposeDetailDlg(String m_billType, String m_operator,
			String m_pkcorp, String m_nodeKey, TbGeneralBVO[] chlids) {
	...
	private void init(String m_billType, String m_operator, String m_pkcorp,
			String m_nodeKey, TbGeneralBVO[] chlids) {
	...
	public AggregatedValueObject[] getReturnVOs(TbGeneralBVO[] childs) {
	...
	public void loadHeadData(TbGeneralBVO[] childs) {
		// 获得表头
		TbGeneralBVO[] tbGeneralBVO = childs;

		// 获得表体
		StringBuffer sql = new StringBuffer(
				"select cdt_pk from bd_cargdoc_tray where cdt_invbasdoc='"
						+ tbGeneralBVO[0].getGeb_cinvbasid() + "' and dr=0 ");
		...
		tbbsql.append(childs[0].getGeb_cgeneralbid());
	...
	public TbGeneralBVO[] getChlids() {
		return chlids;
	}

	public void setChlids(TbGeneralBVO[] chlids) {
		this.chlids = chlids;
	}
