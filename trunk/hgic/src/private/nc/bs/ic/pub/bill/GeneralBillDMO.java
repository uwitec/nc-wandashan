...
//		/**
//		 * 将材料出库 调拨出库 销售出库  签字时  货位校验去掉
//		 * @author zhw
//		 * @说明：（鹤岗矿业） 2011-1-8下午09:13:09
//		 * 
//		 */
//		if( !voHead.getCbilltypecode().equals(ScmConst.m_saleOut)
//				&& !voHead.getCbilltypecode().equals(ScmConst.m_materialOut) 
//				&& !voHead.getCbilltypecode().equals(ScmConst.m_allocationOut)){
		if( !voHead.getCbilltypecode().equals(ScmConst.m_purchaseIn)){
