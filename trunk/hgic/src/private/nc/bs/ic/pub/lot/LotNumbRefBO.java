...
public ArrayList queryAllLotNum(Object[] params, ArrayList FreeItemValue)
	...
	try {
		...
		//ncm_wanghfa_鹤岗煤矿_可用量为空查询批次时报错
		if(alAllData!=null){
			LotNumbRefVO[] voaAllData = new LotNumbRefVO[alAllData.size()];
			alAllData.toArray(voaAllData);
			//@修改人：刘家清  修改时间：2010-3-23 上午10:25:40 修改原因：batchcodeDocFiels
			GenMethod.execFormulaBatchCode(voaAllData,IItemKey.batchcodeDocFiels, "cqualitylevelname");
		}
	} catch (Exception e) {		
		GenMethod.throwBusiException(e);
