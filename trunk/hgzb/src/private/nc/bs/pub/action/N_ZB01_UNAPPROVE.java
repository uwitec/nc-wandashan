 ...
 *
 */
public class N_ZB01_UNAPPROVE extends AbstractCompiler2 {
	private java.util.Hashtable m_methodReturnHas = new java.util.Hashtable();
	private Hashtable m_keyHas = null;

	public N_ZB01_UNAPPROVE() {
		super();
	}
	...
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			if(bill.getHeader().getIbusstatus()>ZbPubConst.BIDDING_BUSINESS_STATUE_INIT)
				throw new BusinessException("标书已进入招标流程,不能再弃审");
