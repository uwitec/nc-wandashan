...
public class WriteBackTool{
	...
	public static void check(
		...
		str.append(" )");
		int ivalue = PuPubVO.getInteger_NullAs(getDao().executeQuery(str.toString(), ResultSetProcessorTool.COLUMNPROCESSOR), 0);
		if(ivalue>0)
		...
		ivalue = PuPubVO.getInteger_NullAs(getDao().executeQuery(str.toString(), ResultSetProcessorTool.COLUMNPROCESSOR), 0);
		if(ivalue>0)
