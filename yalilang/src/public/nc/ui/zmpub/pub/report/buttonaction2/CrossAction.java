...
public class CrossAction extends AbstractActionHasDataAvailable {
	...
	public void execute() throws Exception {
		...
		if (dlg.getResult() == UIDialog.ID_OK) {
			...
			try {
				...
				getUI();
				ReportRowColCrossTool.onCross(getUI(),mrsmd,vc,items, rows, cols, vals,istotal,leaval);
				// 设置缓存
	...
	public void execute2(String[] rows, String[] cols, String[] vals,
		...
		getUI();
		ReportRowColCrossTool.onCross(getUI(),mrsmd,vc,items, rows, cols, vals,istotal2.booleanValue(),lel);		
	}
}
