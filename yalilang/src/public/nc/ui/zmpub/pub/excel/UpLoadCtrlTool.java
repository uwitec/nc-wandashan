...
public class UpLoadCtrlTool {
		 ...
		 */
		public ReportBaseVO[] UpLoadFiles(String pk_corp, String[] sFilePath, String sDir, String user, String logDate) throws java.lang.Exception {
		   return	UpLoadFiles(pk_corp, sFilePath, sDir, false, user,logDate, false);
		}
		/**
		 * liuys
		 * 
		...
		public ExcelReadCtrl getCa(String spath,boolean flag) throws Exception{
			...
			if(cl==null || cl.length()==0)
		      ...
		      Constructor ctor=cls.getConstructor(new Class[]{String.class,boolean.class});

		      this.ca=(ExcelReadCtrl)ctor.newInstance(new Object[]{spath,flag});			
			}
...
//					}
			...
			try {
				...
				MessageDialog.showErrorDlg(ui, nc.ui.ml.NCLangRes
		...
		private void isUpLoadFileSuccessNew(String isSuccess,AbstractBillUI ui) {
			...
			if (isSuccess != null && isSuccess.length() > 0
				...
				MessageDialog
						.showWarningDlg(ui, "提示", nc.ui.ml.NCLangRes
		 ...
		 * @throws Exception
		 */
		public SuperVO[] exeChange(ReportBaseVO[] vos,String pk_corp,String m_user,String logDate)throws Exception{
			...
			SuperVO[] newvos=vchangevo( returnClass, vos, fieldsNames,queryIds, queryTables, querySelectIDs,	queryCodeNames,isQueCorps,isMutiTables,setValueIds
					 ,pk_corp,m_user,logDate);			
			return newvos;
		}
		private String bo="nc.bs.bill.pub.ExcetBO";
		public  SuperVO[] vchangevo(String returnClass,ReportBaseVO[] vos,
				String fieldsNames[],String queryIds[],
				String queryTables[],String querySelectIDs[],
				String[] queryCodeNames,boolean[] isQueCorps,
				boolean[] isMutiTables,
				String [] setValueIds,
				String pk_corp,String m_user,
				String logDate)throws Exception{
			Class[] ParameterTypes = new Class[]{String.class,ReportBaseVO[].class,
			...
			Object[] ParameterValues = new Object[]{returnClass,vos,
					fieldsNames,queryIds,
					queryTables,querySelectIDs,
					queryCodeNames,isQueCorps,
					isMutiTables,
					setValueIds,
					pk_corp,m_user,
					logDate};
			SuperVO[] voss= (SuperVO[]) LongTimeTask.callRemoteService("ic",bo, "excelChangeToVO", ParameterTypes, ParameterValues, 2);
		    return voss;
		}
